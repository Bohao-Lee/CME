...
root = '/home/ubuntu/Fewshot_Detection/Fewshot_Detection/data/cocosplit'
validfile = '/home/ubuntu/Dataset/MSCOCO2014/5k.txt'
trainfile = '/home/ubuntu/Dataset/MSCOCO2014/trainvalno5k.txt'
validdir = '/home/ubuntu/Dataset/MSCOCO2014/images/val2014'
traindir = '/home/ubuntu/Dataset/MSCOCO2014/images/train2014'
few_nums = [10]
...
def get_bbox_fewlistv2(rootdir, shot, tgtclasses):
    ...
    def get_bcls(name):
        ...
        imgpath = '/home/ubuntu/Dataset/MSCOCO2014' + imgpath
        
        labpath = get_labelpath(imgpath)
        
        #imgpath = 
        
        #print("imgpath,labpath")
        #print(imgpath,labpath)
        if not path.exists(labpath) or not path.getsize(labpath):
             return None
        # Load converted annotations
